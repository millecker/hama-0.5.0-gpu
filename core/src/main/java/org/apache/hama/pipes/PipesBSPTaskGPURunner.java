 ...
 */
public class PipesBSPTaskGPURunner<K1 extends WritableComparable, V1 extends Writable,
  ...
  public PipesBSPTaskGPURunner(BSPTask bspTask, GroomServer groom, BSPJob conf) {
  ...
  public void run(RecordReader<K1, V1> input, OutputCollector<K2, V2> output) throws IOException {
